...
namespace EduHome.Controllers
{
    public class EventController : Controller
    {
        ...
        public IActionResult EventDetail(int? id)
        {
            ...
            {
                Event = _context.Events.Include(e => e.EventDescriptions).Include(t => t.EventTags).ThenInclude(t => t.Tag).Include(e=>e.EventSpeakers).ThenInclude(e=>e.Teacher).FirstOrDefault(e => e.Id == id),
